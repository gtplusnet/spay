...
@Component({
  selector: 'app-become02-community-manager',
  templateUrl: './become02-community-manager.component.html',
  styleUrls: ['./become02-community-manager.component.scss']
})
export class Become02CommunityManagerComponent implements OnInit {
	company_name 				: string;
	industry	 				: string;
  ...
  ngOnInit() {
  	...
  	this.remarks		 			= "community-manager";
