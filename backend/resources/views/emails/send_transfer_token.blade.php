...
<p style="text-indent: 50px;">
	You have received <strong>{{$log_amount}} LOKAL Tokens </strong> manually transferred by the lokalize team.
</p>
<div class="text-center"><strong>Remarks:</strong> {{$remarks}}</div>
<small><em>
	To check your total tokens. Go to www.lokalize.io, <strong>Login</strong> your account and in member dashboard you will see the amount of tokens you have.
</em></small>
