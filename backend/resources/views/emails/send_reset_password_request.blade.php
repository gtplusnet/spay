...
<div style="text-align: center; padding: 15px 0px;">
	<a href="http://successpay.io/reset_password/{{$request["forget_account_request_id"]}}" target="_blank" style="padding: 12px; border: 1px solid #005d12; background: #005d12; color: #eee; cursor: pointer; text-decoration: none; font-size: 13px;">Reset Your Password</a>
</div>
@endsection