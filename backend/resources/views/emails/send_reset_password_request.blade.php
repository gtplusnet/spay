...
<div style="text-align: center; padding: 15px 0px;">
	<a href="https://lokalize.io/reset_password/{{$request["forget_account_request_id"]}}" target="_blank" style="padding: 12px; border: 1px solid rgba(10,0,39,1); background: rgba(10,0,39,0.8); color: #eee; cursor: pointer; text-decoration: none; font-size: 13px;">Reset Your Password</a>
</div>
@endsection