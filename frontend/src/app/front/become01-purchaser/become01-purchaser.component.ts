...
@Component({
  selector: 'app-become01-purchaser',
  templateUrl: './become01-purchaser.component.html',
  styleUrls: ['./become01-purchaser.component.scss']
})
export class Become01PurchaserComponent implements OnInit {
	company_name 				: string;
	industry	 				: string;
