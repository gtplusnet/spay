...
@Component({
  selector: 'app-become04-marketing-director',
  templateUrl: './become04-marketing-director.component.html',
  styleUrls: ['./become04-marketing-director.component.scss']
})
export class Become04MarketingDirectorComponent implements OnInit {
      ...
      ngOnInit() {
      	...
      	this.remarks		 			= "marketing-director";
