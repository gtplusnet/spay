...
@Component({
  selector: 'app-become05-advisor',
  templateUrl: './become05-advisor.component.html',
  styleUrls: ['./become05-advisor.component.scss']
})
export class Become05AdvisorComponent implements OnInit {
