      ...
      [
        {
          ...
          provider: new FacebookLoginProvider("2254620324751041")
        },
        {
          id: GoogleLoginProvider.PROVIDER_ID,
          provider: new GoogleLoginProvider("821875705180-lnfvgc267k2pnpvmedhb3jfg9qvkhbhr.apps.googleusercontent.com")
        },
      ]
  );
  return config;
