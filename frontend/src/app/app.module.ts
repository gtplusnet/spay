      ...
      [
        {
          ...
          provider: new FacebookLoginProvider("1771300509621991")
        },
        {
          id: GoogleLoginProvider.PROVIDER_ID,
          provider: new GoogleLoginProvider("306340385193-kcqksc04q8gt3nn3ne639fus2qbht66g.apps.googleusercontent.com")
        },
      ]
  );
  return config;
